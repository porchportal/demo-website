        ...
        <div className="page-wrapper">
          ...
          <div className="button-container">
            ...
            >
              ...
              {pageLabels.instagramButton}
            </a>

            <a
              href={pageLabels.linkedinUrl}
              target="_blank"
              rel="noopener noreferrer"
            ...
            >
              ...
              {pageLabels.linkedinButton}
            </a>

            <a
              href={pageLabels.lineUrl}
              target="_blank"
              rel="noopener noreferrer"
              className="social-button line-button"
            >
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
              ...
              {pageLabels.lineButton}
            </a>

            <a
              href={`mailto:${pageLabels.email}`}
          ...
          <div className="website-preview-section">
            <div className="website-preview-container">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="preview-click-overlay"
              >
                <div className="preview-overlay">
                  <div className="preview-text">
                    ...
                    <span>Visit OpenMirai Platform</span>
                  </div>
                </div>
              </a>
              <iframe
                src={pageLabels.websiteUrl}
                className="website-preview-iframe"
                title="OpenMirai Website Preview"
                loading="lazy"
                scrolling="yes"
              />
            </div>
          ...
          <div className="team-section">
            <Image
              src={getAssetPath("/assets/images/team.jpg")}
              alt="OpenMirai Team"
              width={1200}
              height={800}
